...
class model_s(object):
    mo=xgb.XGBRegressor()
    def __init__(self):
        trainFilePath = '/home/zionxie/sl/train_sulfur.csv'
        testFilePath = '/home/zionxie/sl/test.csv'

        model_s.mo = self.trainmodel(trainFilePath, testFilePath)
    ...
    def trainmodel(self,trainpath: object, testpath: object) -> object:
        ...
        mo= self.trainandTest(x_np, y_np, t_np)
        return mo
    ...
    def trainandTest(self,X_train, y_train, X_test):
        ...
        mo = xgb.XGBRegressor(max_depth=5, learning_rate=0.1, n_estimators=160, silent=True, objective='reg:gamma')
